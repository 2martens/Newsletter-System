...
<div id="main">
	...
	<hr />
	<div id="legalNotice">
		<h6>{lang}wcf.acp.newsletter.legalNotice{/lang}:</h6>
		<p>{if 'LEGAL_NOTICE_ADDRESS'|defined && LEGAL_NOTICE_ADDRESS != ''}{@LEGAL_NOTICE_ADDRESS}{else}{@MESSAGE_NEWSLETTERSYSTEM_GENERAL_LEGALNOTICE}{/if}<br />
